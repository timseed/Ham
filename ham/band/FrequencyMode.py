class FrequencyMode(object):
    ...
    def __init__(self, contest=True):
        ...
        self.bm_contest['CW'] = [(1810.0, 1840.0),
                                 (3500.0, 3570.0),
                                 (7000.0, 7060.0),
                                 (14000.0, 14065.0),
                                 (21000.0, 21065.0),
        ...
        self.bm_contest['SSB'] = [(3650.0, 3850.0),
                                  (7060.0, 7200.0),
                                  (14120.0, 14400.0),
                                  (21120, 21400.0),
                                  (28350, 28600.0)]

        self.bm_contest['RTTY'] = [(14065, 14099.0),
                                   (14101.0, 14120.0),
                                   (21065.0, 21099.0),
                                   (21101.0, 21120.0),
                                   (28065.0, 28120.0),
        ...
        self.bm_no_contest['CW'] = [(1810, 1840),
                                    (3500.0, 3570.0),
                                    (7000.0, 7040.0),
                                    (10100.0, 10130.0),
                                    (14000.0, 14060.0),
                                    ...
                                    (24890.0, 24915.0),
                                    (28000.0, 28065.0)]
        self.bm_no_contest['SSB'] = [(3650.0, 3850.0),
                                     (7060.0, 7200.0),
                                     (14120.0, 14400.0),
                                     (18120.0, 18168.0),
                                     (21120.0, 21400.0),
                                     (24940.0, 24990.0),
                                     (28350.0, 28600.0)]
        self.bm_no_contest['RTTY'] = [(14065.0, 14099.0),
                                      (21065.0, 21099.0),
                                      (24915.0, 24925.0),
                                      (28065.0, 28120.0),
                                      ]

    def Mode(self, FreqInKhz: float) -> str:
        """
        ...
        for freq_range in check_data['FT8']:
            if FreqInKhz > freq_range[0] and FreqInKhz < freq_range[1]:
                return 'FT8'
        else:
